...
import { fetchLocations, fetchWeatherForecast } from '../api/whether.js';
...
export default function HomeScreeen(){
    ...
    const handleLocation = async (loc) =>{
        ...
        try {
            ...
            console.log("No whether data found!");
        }
    }
    ...
    const fetchMyWeatherData = async ()=>{
        ...
        try {
            ...
            console.log("My city data not found!");
        }finally{
            setLoading(false);
        }
    }
...

            {
                loading ? (
                    <View className="flex-1 flex-row justify-center items-center">
                        <Progress.CircleSnail thickness={10} size={140} color="#c9a41e" />
                    </View>
                ) : (           
                    <SafeAreaView className="flex flex-1" >
                        ...
                        <View style={{height: '7%'}} className="mx-4 relative z-50 ">
                            <View 
                                className="flex-row justify-end items-center rounded-full mt-1" 
